...
const appReducer = (state, action)=>{
    switch(action.type){
        ...
        case ActionTypes.UPDATE_BOOK:
            var _state_currentBook;
            return {
                ...state,
                books: state.books.map((book)=>book.id === action.payload.id ? action.payload : book),
                currentBook: ((_state_currentBook = state.currentBook) === null || _state_currentBook === void 0 ? void 0 : _state_currentBook.id) === action.payload.id ? action.payload : state.currentBook
            };
        case ActionTypes.DELETE_BOOK:
            var _state_currentBook1;
            return {
                ...state,
                books: state.books.filter((book)=>book.id !== action.payload),
                currentBook: ((_state_currentBook1 = state.currentBook) === null || _state_currentBook1 === void 0 ? void 0 : _state_currentBook1.id) === action.payload ? null : state.currentBook
            };
...
const AppProvider = (param)=>{
    ...
    const setLoading = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[setLoading]": (loading)=>{
            dispatch({
                type: ActionTypes.SET_LOADING,
                payload: loading
            });
        }
    }["AppProvider.useCallback[setLoading]"], []);
    const setError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[setError]": (error)=>{
            dispatch({
                type: ActionTypes.SET_ERROR,
                payload: error
            });
        }
    }["AppProvider.useCallback[setError]"], []);
    ...
    const setBooks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[setBooks]": (books)=>{
            dispatch({
                type: ActionTypes.SET_BOOKS,
                payload: books
            });
        }
    }["AppProvider.useCallback[setBooks]"], []);
    const setCurrentBook = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[setCurrentBook]": (book)=>{
            dispatch({
                type: ActionTypes.SET_CURRENT_BOOK,
                payload: book
            });
        }
    }["AppProvider.useCallback[setCurrentBook]"], []);
    const addBook = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[addBook]": (book)=>{
            dispatch({
                type: ActionTypes.ADD_BOOK,
                payload: book
            });
        }
    }["AppProvider.useCallback[addBook]"], []);
    const updateBook = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[updateBook]": (book)=>{
            dispatch({
                type: ActionTypes.UPDATE_BOOK,
                payload: book
            });
        }
    }["AppProvider.useCallback[updateBook]"], []);
    const deleteBook = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[deleteBook]": (bookId)=>{
            dispatch({
                type: ActionTypes.DELETE_BOOK,
                payload: bookId
            });
        }
    }["AppProvider.useCallback[deleteBook]"], []);
    const addNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[addNotification]": (notification)=>{
            dispatch({
            ...
            if (notification.autoHide !== false) {
                ...
                }["AppProvider.useCallback[addNotification]"], notification.duration || 5000);
            }
        }
    }["AppProvider.useCallback[addNotification]"], []);
    const removeNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[removeNotification]": (id)=>{
            dispatch({
                type: ActionTypes.REMOVE_NOTIFICATION,
                payload: id
            });
        }
    }["AppProvider.useCallback[removeNotification]"], []);
    const setTheme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[setTheme]": (theme)=>{
            dispatch({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AppContext.Provider, {
        ...
        fileName: "[project]/src/context/AppContext.js",
        lineNumber: 173,
        columnNumber: 5
    }, ("TURBOPACK compile-time value", void 0));
};
_s(AppProvider, "ANRYOBz2odhK+q++xtVIkgVIQ2c=");
_c = AppProvider;
const useAppContext = ()=>{
    _s1();
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("head", {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("meta", {
                        name: "description",
                        content: "AI 赋能的智能阅读平台，让每一次阅读都更有价值"
                    }, void 0, false, {
                        fileName: "[project]/src/app/layout.tsx",
                        lineNumber: 27,
                        columnNumber: 9
...
//# sourceMappingURL=%5Broot-of-the-server%5D__93d20efb._.js.map